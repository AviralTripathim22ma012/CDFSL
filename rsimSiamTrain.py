...
from methods.rsimSiamBaseline import BaselineTrain
from methods.protonet import ProtoNet

from io_utils import model_dict, parse_args, get_resume_file
from datasets import simsiam_miniImageNet_few_shot, DTD_few_shot

print('sim siam with rotation')
...
if __name__=='__main__':
    ...
    if params.method in ['baseline'] :
        ...
        if params.dataset == "miniImageNet":
            ...
            datamgr = simsiam_miniImageNet_few_shot.SimpleDataManager(image_size, batch_size = 16)
    ...
    if params.train_aug:
        params.checkpoint_dir += '_simSiamRotation'
