...
print ("Loading 2 images: (img1, img2, label)")
...
class SubDataset:
    ...
    def __getitem__(self,i):
        ...
        crop = self.transform1(self.sub_meta[i])
        img = self.transform2(self.sub_meta[i])
...
class SetDataManager(DataManager):
    ...
    def get_data_loader(self, aug1, aug2): #parameters that would change on train/val set
        transform1 = self.trans_loader.get_composed_transform(aug=aug1)
        transform2 = self.trans_loader.get_composed_transform(aug=aug2)
