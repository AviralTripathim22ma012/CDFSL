...
from methods.adverserialBaselineTrain import BaselineTrain
...
print('Adverserial Training with rotation the Pre trained model')
...
if __name__=='__main__':
    ...
    if params.train_aug:
        params.checkpoint_dir += '_adverserial'
