...
from methods.grayBaselinetrain import BaselineTrain
from methods.protonet import ProtoNet

from io_utils import model_dict, parse_args, get_resume_file
from datasets import gray_miniImageNet_few_shot, DTD_few_shot
...
if __name__=='__main__':
    ...
    if params.method in ['baseline'] :
        ...
        if params.dataset == "miniImageNet":
            ...
            datamgr = gray_miniImageNet_few_shot.SimpleDataManager(image_size, batch_size = 16)
